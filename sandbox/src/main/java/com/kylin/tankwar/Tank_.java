...
public class Tank_ {
	...
	private static final Logger logger = Logger.getLogger(Tank_.class);
	...
	public Tank_(int x, int y, boolean good) {
		this.x = x;
		this.y = y;
		this.oldX = x;
		this.oldY = y;
	...
	public Tank_(int x, int y, boolean good, Direction dir,  TankFrame tc) {
		this(x, y, good);
		this.dir = dir;
		this.tc = tc;
...
//		y = this.y + Tank.HEIGHT/2 - Missile.HEIGHT/2 ;
	...
	public boolean collidesWithTanks(java.util.List<Tank_> tanks) {
	...
	public TankView getTankDraw() {
		return new TankView(id, good, live, life, x, y, dir, ptDir);
	}
	 ...
	 * @param td
	 */
	public void updateTank(TankView td){
