 ...
 *   
 * How to Run?
 *   java -cp target/infinispan-quickstart.jar:target/dependency/* -Djava.net.preferIPv4Stack=true org.infinispan.quickstart.cluster.DistNode 1
 *   java -cp target/infinispan-quickstart.jar:target/dependency/* -Djava.net.preferIPv4Stack=true org.infinispan.quickstart.cluster.DistNode 2
 *   java -cp target/infinispan-quickstart.jar:target/dependency/* -Djava.net.preferIPv4Stack=true org.infinispan.quickstart.cluster.DistNode 3
 *   java -cp target/infinispan-quickstart.jar:target/dependency/* -Djava.net.preferIPv4Stack=true org.infinispan.quickstart.cluster.DistNode 4
 * 
 * 
 * @author kylin
 *
...
public class DistNode extends AbstractNode {
	...
	public static void main(String[] args) throws Exception {
		if(args.length <= 0) {
			...
			System.out.println("    org.infinispan.quickstart.cluster.DistNode X");
